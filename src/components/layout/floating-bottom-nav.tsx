          ...
          <DialogContent className="max-w-sm border-border bg-white">
            ...
            <div className="grid gap-1 pt-2">
              ...
              <Link
                ...
                prefetch={false}
                onClick={() => setOverflowOpen(false)}
                className="mt-2 flex items-center gap-2 rounded-xl border-t border-border px-3 py-2.5 pt-4 text-sm font-semibold text-ink/50"
              >
                User terminal
              </Link>
            </div>
        ...
        <Dialog open={overflowOpen} onOpenChange={setOverflowOpen}>
          <DialogContent className="max-w-sm border-border bg-white">
            ...
            <Link
              ...
              className={cn(
                "flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold",
                pathname.startsWith("/admin") ? "text-orange" : "text-ink/70"
              )}
            >
