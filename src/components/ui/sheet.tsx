  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-card text-sm text-ink shadow-float outline-none transition duration-200 ease-in-out",
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-sm text-muted-label", className)}
      {...props}
    />
  )
}
